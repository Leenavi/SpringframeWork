  ...
  <div class="product-detail-container">
    ...
    <div class="product-images">
      <div class="main-image">
       <img src="${dto.imgPaths[0].imgPath}" alt="대표 이미지" />
      </div>
      <div class="thumb-list">
		  <c:forEach var="img" items="${dto.imgPaths}">
		    <div class="thumb">
		      <img src="${img.imgPath}" alt="썸네일" />
		    </div>
		  </c:forEach>
		</div>
    ...
    <div class="product-info">
      ...
      <div>
        <span class="option active">${dto.product.condition}</span>
        <span class="grade active">${dto.board.status}</span>
      </div>
